...
dataset = tf.data.Dataset.from_tensor_slices(
    (input_tensor_train,
     target_tensor_train)).shuffle(BUFFER_SIZE).batch(BATCH_SIZE,
                                                      drop_remainder=True)
...
class BahdananAttention(tf.keras.layers.Layer):
...
attention_layer = BahdananAttention(10)
...
class Decoder(tf.keras.Model):
    def __init__(self, vocab_size, embedding_dim, dec_units, batch_sz):
        ...
        self.attention = BahdananAttention(self.dec_units)
